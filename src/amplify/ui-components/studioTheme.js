...
export default createTheme({
  ...
  tokens: {
    ...
    colors: {
      ...
      brand: {
        primary: {
          10: { value: "hsl(241, 39%, 77%)" },
          20: { value: "hsl(241, 39%, 73%)" },
          40: { value: "hsl(242, 39%, 64%)" },
          60: { value: "hsl(241, 39%, 55%)" },
          80: { value: "hsl(242, 32%, 44%)" },
          90: { value: "hsl(241, 32%, 33%)" },
          100: { value: "hsl(241, 32%, 28%)" },
        },
        secondary: {
          10: { value: "hsl(188, 51%, 88%)" },
          20: { value: "hsl(188, 51%, 86%)" },
          40: { value: "hsl(187, 51%, 81%)" },
          60: { value: "hsl(188, 51%, 76%)" },
          80: { value: "hsl(187, 25%, 61%)" },
          90: { value: "hsl(188, 16%, 46%)" },
          100: { value: "hsl(188, 16%, 38%)" },
        },
      },
      font: {
        primary: { value: "hsl(192, 38%, 5%)" },
        secondary: { value: "hsl(180, 3%, 25%)" },
        tertiary: { value: "hsl(195, 3%, 53%)" },
        disabled: { value: "{colors.font.tertiary.value}" },
        inverse: { value: "hsl(300, 12%, 92%)" },
      ...
      background: {
        ...
        secondary: { value: "hsl(300, 12%, 92%)" },
        tertiary: { value: "hsl(188, 51%, 76%)" },
